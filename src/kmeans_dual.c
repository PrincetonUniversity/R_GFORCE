...
// FUNCTION PROTOTPES
void precompute_values(double* Y_a_base, int* group_sizes, double* primal_value, double* D, int* ga_hat,
                        int d, int K, double* dwork, int* iwork);
void compute_Y_a(double* Y_a_base, double* Y_a_new, double Y_T, int* ga_hat, int* group_sizes, int d);
...
void precompute_values(double* Y_a_base, int* group_sizes, double* primal_value,
                        double* D, int* ga_hat, int d, int K, double* dwork, int* iwork) {
    // Local Vars
